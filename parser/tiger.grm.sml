\\008\000\008\000\044\000\097\000\
\\008\000\083\000\021\000\028\000\
\\104\000\008\000\032\000\017\000\
\\008\000\022\000\023\000\041\000\
\\072\000\008\000\070\000\105\000\
\\103\000\090\000\008\000\024\000\
\\107\000\092\000\045\000\108\000\
\\008\000\098\000\091\000\046\000\
\\008\000\074\000\008\000\094\000\
\\093\000\000\000"
val gotoT =
"\
\\001\000\002\000\002\000\145\000\003\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\008\000\065\000\009\000\033\000\010\000\032\000\013\000\031\000\
...
\\001\000\077\000\003\000\001\000\000\000\
\\001\000\079\000\003\000\001\000\005\000\078\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\001\000\044\000\003\000\001\000\004\000\082\000\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\001\000\113\000\003\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\011\000\105\000\012\000\115\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\001\000\143\000\003\000\001\000\000\000\
\\000\000\
...
datatype svalue = VOID | ntVOID of unit ->  unit
 ...
 | vardec of unit ->  (A.dec) | funDecs of unit ->  (A.fundec list)
...
explist1, _, _)) :: _ :: ( _, ( MlyValue.ID ID1, (IDleft as ID1left),
 ...
 in (
A.CallExp{func = Symbol.symbol ID,      args = explist,              pos = IDleft}
)
end)
...
ID1) = ID1 ()
 ...
 in (
A.RecordExp{fields = field, typ = Symbol.symbol ID,                  pos=IDleft}
)
end)
...
declarationlist1) = declarationlist1 ()
 ...
 in (
A.LetExp{decs = declarationlist, body = A.SeqExp expseq,                      pos = LETleft}
)
end)
...
|  ( 34, ( ( _, ( MlyValue.exp exp1, expleft, exp1right)) :: _ :: ( _,
...
|  ( 37, ( ( _, ( MlyValue.declaration declaration1, declaration1left,
 declaration1right)) :: rest671)) => let val  result = 
MlyValue.declarationlist (fn _ => let val  (declaration as 
...
|  ( 38, ( ( _, ( MlyValue.declaration declaration1, _, 
...
|  ( 44, ( ( _, ( MlyValue.exp exp1, _, exp1right)) :: _ :: _ :: ( _, 
...
|  ( 45, ( ( _, ( MlyValue.exp exp1, _, exp1right)) :: _ :: _ :: _ :: 
...
, (FUNCTIONleft as FUNCTION1left), _)) :: rest671)) => let val  result
 ...
 val  (exp as exp1) = exp1 ()
 in (
{name = Symbol.symbol ID1, params = typefields,
...
|  ( 48, ( ( _, ( MlyValue.functiondeclaration functiondeclaration1, 
...
|  ( 49, ( ( _, ( MlyValue.functiondeclaration functiondeclaration1, _
...
|  ( 53, ( ( _, ( MlyValue.typedeclaration typedeclaration1, 
...
|  ( 54, ( ( _, ( MlyValue.typedeclaration typedeclaration1, _, 
...
|  ( 56, ( ( _, ( _, _, RBRACE1right)) :: ( _, ( MlyValue.typefields 
...
|  ( 59, ( ( _, ( MlyValue.typefield typefield1, typefield1left, 
...
|  ( 60, ( ( _, ( MlyValue.typefield typefield1, _, typefield1right))
