...
fun yyAction5 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN STR; string_in := 1; last_open_string := yypos; s:=""; continue()))
fun yyAction6 (strm, lastMatch : yymatch) = (yystrm := strm;
      ( YYBEGIN INITIAL; string_in := 0; Tokens.STRING(!s, !last_open_string, yypos+1)))
...
fun yyAction22 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (ErrorMsg.error yypos ("Illegal token in formatting block: " ^ yytext); continue())
      end
fun yyAction23 (strm, lastMatch : yymatch) = (yystrm := strm;
      (ErrorMsg.error yypos "Illegal escape character"; continue()))
fun yyAction24 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (s := !s ^ yytext; continue())
      end
fun yyAction25 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm;
        (s := !s ^ yytext;lineNum := !lineNum+1; linePos := yypos :: !linePos; continue())
      end
fun yyAction26 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm;
        (ErrorMsg.error yypos ("Illegal string character, likely a bad escape: " ^ yytext); continue())
      end
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction68(strm, yyNO_MATCH)
                      else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction40(strm, yyNO_MATCH)
                      else yyQ76(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction40(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ80(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ79(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"l"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ78(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"i"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ77(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"h"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction29(strm, yyNO_MATCH)
                      else yyQ76(strm', yyMATCH(strm, yyAction29, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction29(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction29, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ81(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
              else yyAction68(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction28(strm, yyNO_MATCH)
                      else yyQ76(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction28(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ76(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ87(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ86(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"p"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction42(strm, yyNO_MATCH)
                      else yyQ76(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction42(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ88(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"a"
              ...
              then if inp = #"i"
                  ...
                  then if inp = #"h"
                      then yyQ83(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
                      else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
                else if inp = #"o"
                  then yyQ84(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp = #"z"
              then yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"z"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction32(strm, yyNO_MATCH)
                      else yyQ76(strm', yyMATCH(strm, yyAction32, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction32(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction32, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ90(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"f"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction35(strm, yyNO_MATCH)
                      else yyQ76(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction35(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ92(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"l"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ91(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"i"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction36(strm, yyNO_MATCH)
                      else yyQ76(strm', yyMATCH(strm, yyAction36, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction36(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction36, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ94(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"t"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ93(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction34(strm, yyNO_MATCH)
                      else yyQ76(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction34(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction43(strm, yyNO_MATCH)
                      else yyQ76(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction43(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then yyQ96(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"f"
                  then yyQ95(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
              else yyAction68(strm, yyNO_MATCH)
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction30(strm, yyNO_MATCH)
                      else yyQ76(strm', yyMATCH(strm, yyAction30, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction30(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction30, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ104(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ103(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"o"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ102(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"i"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ101(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"t"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ100(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"c"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ99(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction39(strm, yyNO_MATCH)
                      else yyQ76(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction39(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ105(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then yyQ98(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"u"
              then if inp = #"o"
                  then yyQ97(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
              else yyAction68(strm, yyNO_MATCH)
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction33(strm, yyNO_MATCH)
                      else yyQ76(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction33(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ76(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ108(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"d"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ110(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ109(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"s"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then yyQ107(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"l"
                  then yyQ106(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
              else yyAction68(strm, yyNO_MATCH)
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction37(strm, yyNO_MATCH)
                      else yyQ76(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction37(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ111(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"o"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction31(strm, yyNO_MATCH)
                      else yyQ76(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction31(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ115(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"k"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ114(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
              else yyAction68(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ113(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ112(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction44(strm, yyNO_MATCH)
                      else yyQ76(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction44(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ119(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"y"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ118(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
              else yyAction68(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ117(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
       ...
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ116(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction68(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
...
fun yyQ57 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction49(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ120(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
...
fun yyQ55 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ122(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
...
fun yyQ53 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction66(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ123(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
...
fun yyQ124 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction69(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ124(strm', yyMATCH(strm, yyAction69, yyNO_MATCH))
            else if inp < #"0"
...
fun yyQ51 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction54(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ125(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
       ...
       of NONE => yyAction0(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\n"
              ...
              then if inp = #"\t"
                  then yyQ126(strm', yyMATCH(strm, yyAction0, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"^"
              ...
              then if inp = #"\""
                  ...
                  then if inp = #"0"
                      then yyQ17(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
                    else if inp < #"0"
                      then yyAction23(strm, yyNO_MATCH)
                    else if inp = #"2"
                      then yyQ18(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
                      else yyQ17(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
                else if inp = #"\\"
...
in
  (case (!(yyss))
   of FMT => yyQ0(!(yystrm), yyNO_MATCH)
    | STR => yyQ1(!(yystrm), yyNO_MATCH)
