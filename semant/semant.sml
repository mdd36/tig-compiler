    		...
    		in
                case ty of
                    ...
                    |   SOME((name, pos)) => (case searchTy(tenv, name, pos) of
                            Types.RECORD(tl, u) => (print("haha\n");{venv=Symbol.enter(venv, name, Env.VarEntry{access=acc, ty=Types.RECORD(tl,u), write=true}), tenv=tenv, exp=TR.assign(translatedVar, exp)})
